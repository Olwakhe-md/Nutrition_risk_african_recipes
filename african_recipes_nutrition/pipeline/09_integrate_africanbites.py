"""
09_integrate_africanbites.py
============================
Integrates the 179 scraped africanbites.com recipes into the nutrition pipeline.

  1. Reads africanbites_scraped.csv
  ...
  5. Assigns new recipe IDs starting from 338
...
SCRAPED_FILE  = os.path.join(DATA_SCRAPED, 'africanbites_scraped.csv')
...
def main():
    print('Integrate AfricanBites Recipes (IDs 338+)')
    print('=' * 50)
    ...
    # Guard: abort if IDs 338+ already exist (script already run)
    ...
    for scraped_recipe in scraped_rows:
        ...
        for ing_index, raw_line in enumerate(raw_ingredients, start=1):
            ...
            mapping_row = {
                ...
                'notes'                  : 'Added from africanbites scraped data',
            }
    ...
    print(f'\nNext: run 10_integrate_food_com.py')
